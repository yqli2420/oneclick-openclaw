...
Download the DMG from [Releases v1.0.0](https://github.com/yqli2420/oneclick-openclaw/releases/tag/v1.0.0), open it, and drag `OpenClaw Desktop.app` to Applications. All dependencies (Node.js, Git, pnpm) are auto-installed on first launch.
